 ...
 *  
 */
package en.hybris.platform.recipes.jalo;
...
import en.hybris.platform.recipes.constants.RecipesConstants;



/**
 * This is the extension manager of the Recipes extension.
 */
public class RecipesManager extends GeneratedRecipesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(RecipesManager.class.getName());
	...
	public RecipesManager() // NOPMD 
	{
		...
		{
			LOG.debug("constructor of RecipesManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of RecipesManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of RecipesManager called, current tenant: " + getTenant().getTenantID());
		}
	}

 ...
 *  
 */
package  de.hybris.platform.project.jalo;
...
import  de.hybris.platform.project.constants.ProjectConstants;



/**
 * This is the extension manager of the Project extension.
 */
public class ProjectManager extends GeneratedProjectManager
{
	...
	{
		return (ProjectManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				ProjectConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public ProjectManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of ProjectManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of ProjectManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of ProjectManager called, current tenant: " + getTenant().getTenantID());
		}
	}
